...
<div class="flex flex-col lg:flex-row w-full h-full pb-2 lg:space-x-6">
	<div
		...
		class="tabs flex flex-row overflow-x-auto gap-1 max-w-full lg:gap-0 lg:flex-col lg:flex-none lg:w-48 text-sm font-medium text-left scrollbar-none lg:h-fit p-2"
	>
		<button
			id="general"
			class="px-3 py-2 min-w-fit rounded-md flex-1 lg:flex-none flex text-left transition {selectedTab ===
			'general'
		...
		>
			<div class=" self-center mr-2">
				...
				>
					...
					/>
					<path
						d="M8 12.5c1.84 0 3.579-.37 4.914-1.037.366-.183.74-.41 1.086-.684V12c0 1.657-2.686 3-6 3s-6-1.343-6-3v-1.22c.346.273.72.5 1.087.684C4.42 12.131 6.16 12.5 8 12.5Z"
					/>
				</svg>
			</div>
