<script lang="ts">
	...
	const shareHandler = async () => {
		toast.success($i18n.t('Redirecting you to Spectra Lite Community'));
		...
		>
			...
			<tbody class="">
				{#each paginatedFeedbacks as feedback (feedback.id)}
					<tr
						class="bg-[#f5f7fa] dark:bg-[#1a1e2e] dark:border-gray-850 text-xs cursor-pointer hover:bg-gray-50 dark:hover:bg-gray-850/50 transition"
			...
			>
				...
				>
					<div class=" self-center mr-2 font-medium line-clamp-1">
						{$i18n.t('Share to Spectra Lite Community')}
					</div>
