...
app.state.config.ENABLE_ADMIN_FUNCTIONS = ENABLE_ADMIN_FUNCTIONS
app.state.config.ENABLE_ADMIN_SETTINGS = ENABLE_ADMIN_SETTINGS
app.state.config.ENABLE_ADMIN_EVALUATIONS = ENABLE_ADMIN_EVALUATIONS
app.state.config.ENABLE_CHAT_VOICE_CONTROLS = ENABLE_CHAT_VOICE_CONTROLS
app.state.config.ENABLE_CHAT_CONTROLS = ENABLE_CHAT_CONTROLS
app.state.config.ENABLE_WORKSPACE = ENABLE_WORKSPACE
app.state.config.ENABLE_FILE_UPLOAD = ENABLE_FILE_UPLOAD
    ...
    return {
        **({"onboarding": True} if onboarding else {}),
        ...
        "features": {
            ...
            "enable_admin_functions": app.state.config.ENABLE_ADMIN_FUNCTIONS,
            "enable_admin_settings": app.state.config.ENABLE_ADMIN_SETTINGS,
            "enable_admin_evaluations": app.state.config.ENABLE_ADMIN_EVALUATIONS,
            "enable_chat_voice_controls": app.state.config.ENABLE_CHAT_VOICE_CONTROLS,
            "enable_chat_controls": app.state.config.ENABLE_CHAT_CONTROLS,
            "enable_workspace": app.state.config.ENABLE_WORKSPACE,
            "enable_file_upload": app.state.config.ENABLE_FILE_UPLOAD,
            **(
                {
...
async def get_current_usage(user=Depends(get_verified_user)):
    """
    Get current usage statistics for Spectra Lite.
