...
from open_webui.env import (
    ...
    WEBUI_FAVICON_URL,
    WEBUI_NAME,
    ENABLE_ADMIN_FUNCTIONS,
    ENABLE_ADMIN_SETTINGS,
    ENABLE_ADMIN_EVALUATIONS,
    ENABLE_CHAT_VOICE_CONTROLS,
    ENABLE_FILE_UPLOAD,
    log,
)
...
if ENV == "prod":
    if OLLAMA_BASE_URL == "/ollama" and not K8S_FLAG:
        if USE_OLLAMA_DOCKER.lower() == "true":
            # if you use all-in-one docker container (Spectra Lite + Ollama)
...
####################################
# ADMIN PANEL FEATURE CONTROLS
####################################

ENABLE_ADMIN_FUNCTIONS = PersistentConfig(
    "ENABLE_ADMIN_FUNCTIONS",
    "admin.functions.enable",
    os.environ.get("ENABLE_ADMIN_FUNCTIONS", "True").lower() == "true",
)

ENABLE_ADMIN_SETTINGS = PersistentConfig(
    "ENABLE_ADMIN_SETTINGS",
    "admin.settings.enable",
    os.environ.get("ENABLE_ADMIN_SETTINGS", "True").lower() == "true",
)

ENABLE_ADMIN_EVALUATIONS = PersistentConfig(
    "ENABLE_ADMIN_EVALUATIONS",
    "admin.evaluations.enable",
    os.environ.get("ENABLE_ADMIN_EVALUATIONS", "True").lower() == "true",
)

ENABLE_CHAT_VOICE_CONTROLS = PersistentConfig(
    "ENABLE_CHAT_VOICE_CONTROLS",
    "chat.voice_controls.enable",
    os.environ.get("ENABLE_CHAT_VOICE_CONTROLS", "True").lower() == "true",
)

ENABLE_CHAT_CONTROLS = PersistentConfig(
    "ENABLE_CHAT_CONTROLS",
    "chat.controls.enable",
    os.environ.get("ENABLE_CHAT_CONTROLS", "True").lower() == "true",
)

ENABLE_WORKSPACE = PersistentConfig(
    "ENABLE_WORKSPACE",
    "workspace.enable",
    os.environ.get("ENABLE_WORKSPACE", "True").lower() == "true",
)
ENABLE_FILE_UPLOAD = PersistentConfig(
    "ENABLE_FILE_UPLOAD",
    "workspace.enable",
    os.environ.get("ENABLE_FILE_UPLOAD", "True").lower() == "true",
)
...
# Add admin feature configurations to app_config
app_config.ENABLE_ADMIN_FUNCTIONS = ENABLE_ADMIN_FUNCTIONS
app_config.ENABLE_ADMIN_SETTINGS = ENABLE_ADMIN_SETTINGS
app_config.ENABLE_ADMIN_EVALUATIONS = ENABLE_ADMIN_EVALUATIONS
app_config.ENABLE_CHAT_VOICE_CONTROLS = ENABLE_CHAT_VOICE_CONTROLS
app_config.ENABLE_CHAT_CONTROLS = ENABLE_CHAT_CONTROLS
app_config.ENABLE_WORKSPACE = ENABLE_WORKSPACE
app_config.ENABLE_FILE_UPLOAD = ENABLE_FILE_UPLOAD
